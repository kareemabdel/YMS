...
namespace YMS.Migrations.Migrations
{
    ...
    [Migration("20241017102639_add-container-gate-in-tbl")]
    partial class addcontainergateintbl
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("YMS.Migrations.Entities.Block", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("YMS.Migrations.Entities.Transporter", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("YMS.Migrations.Entities.Vessel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("YMS.Migrations.Entities.Container", b =>
                {
                    ...
                    b.HasOne("YMS.Migrations.Entities.Vessel", "Vessel")
                        .WithMany()
            ...
            modelBuilder.Entity("YMS.Migrations.Entities.ContainerTransaction", b =>
                {
                    b.HasOne("YMS.Migrations.Entities.Block", "Block")
                        .WithMany()
                    ...
                    b.HasOne("YMS.Migrations.Entities.Transporter", "Transporter")
                        .WithMany()
            ...
            modelBuilder.Entity("YMS.Migrations.Entities.EmptyStorageTariffData", b =>
                {
                    b.HasOne("YMS.Migrations.Entities.EmptyStorageTariff", "EmptyStorageTariff")
                        .WithMany("EmptyStorageTariffDataList")
            ...
            modelBuilder.Entity("YMS.Migrations.Entities.EmptyStorageTariff", b =>
                {
                    b.Navigation("EmptyStorageTariffDataList");
                });
